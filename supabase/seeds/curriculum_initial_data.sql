...
-- 組織ID（既存の組織を使用する場合は適切なIDに変更してください）
DO $$
DECLARE
  v_org_id UUID;
...
BEGIN
  -- デフォルト組織IDを取得（必要に応じて変更）
  SELECT id INTO v_org_id FROM organizations LIMIT 1;
  
  -- 武田塾数学ルート
  INSERT INTO textbook_routes (organization_id, school_name, subject, subject_detail, level)
  VALUES (v_org_id, '武田塾', '数学', '数学IA・IIB', 3)
  ...
  -- 河合塾数学ルート
  INSERT INTO textbook_routes (organization_id, school_name, subject, subject_detail, level)
  VALUES (v_org_id, '河合塾', '数学', '数学IA・IIB', 3)
